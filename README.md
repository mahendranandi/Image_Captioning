...
## Objective:
Our objective is to get a caption from an image. So we need to supply just an image.And the model ( as we will make it learned about the task ) will automatically gnerates a caption which is sifficient to describe the picture. so,the image ilastrate the fact,
...
❖ https://medium.com/@raman.shinde15/image-captioning-with-flickr8k-dataset-bleu-4bcba0b52926#:~:text=BLEU%20s
tands%20for%20Bilingual%20Evaluation,quality%20of%20our%20generated%20caption.&text=It%20is%20easy%20to
%20compute.
